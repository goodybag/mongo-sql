      ...
      for (var key in $query){
        ...
        if (typeof $query[key] === "object"){
          ...
          // $query is array
            ...
            wheres.push(builders._where($query[key], values, collection, ' and ', condition, column));

          // Object is typical query object and key is a column
          else
            wheres.push(builders._where($query[key], values, collection, joiner, condition, key));
        }
