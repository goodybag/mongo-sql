...
helpers.register('join', function(join, values) {
  return ' ' + buildJoin('', join, values);
});

helpers.register('innerJoin', function(join, values) {
  return ' ' + buildJoin('inner', join, values);
});

helpers.register('leftJoin', function(join, values) {
  return ' ' + buildJoin('left', join, values);
});

helpers.register('leftOuterJoin', function(join, values) {
  return ' ' + buildJoin('left outer', join, values);
});

helpers.register('fullOuterJoin', function(join, values) {
  return ' ' + buildJoin('full outer', join, values);
});

helpers.register('crossOuterJoin', function(join, values) {
